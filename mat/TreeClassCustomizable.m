classdef TreeClassCustomizable < rl.env.MATLABEnvironment
    ...
    properties
       ...
       N = 150; % how many steps i n an episode %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
       
       deadzones = [4,6,-4]; % where does the tree live?
    ...
    methods              
        ...
        function this = TreeClassCustomizable(type, n, w)
            ...
            this.L = L;
            this.init_xvals = [4:this.L*this.dt:6];
...
%                 d = [d; mid_pts-w/2 mid_pts+w/2 ones(n,1)*rows];     % use this line for uniform rows of obstacles
                d = [d; mid_pts-w/2 mid_pts+w/2 -rows+(rand(n,1)-.5)];  % use this line for a random offset in y coordinate of obstacles
            end
